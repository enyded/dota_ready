Default/fallback locale screenshots (see `landing/README.md`, "Screenshots and localization").
...
- `app-main.png`, `app-match-found.png` (full phone screen), `app-notification.png` (cropped to
  just the notification banner, used for "Get notified"), `app-party-notification.png` (party
